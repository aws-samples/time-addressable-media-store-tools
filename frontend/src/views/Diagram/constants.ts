...
const createSvgDataUri = (width: number, height: number, pathData: string, fill: string | null = null) => {
...
const createFormatIcon = (pathData: string) => createSvgDataUri(18, 18, pathData);
...
const createFormatStyles = (format:string, d: string, withContainer = false) => {
